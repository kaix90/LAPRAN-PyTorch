...
parser.add_argument('--model', help='basic | woresnet | woresnetup', default='basic_woy')
parser.add_argument('--dataset', help='lsun | imagenet | mnist | bsd500', default='bsd500_patch')
...
elif opt.model == 'basic_woy':
    import models.lapgan_basic_woy as lapgan
...
def data_loader():
    ...
    if opt.dataset == 'lsun':
        ...
        val_dataset = datasets.ImageFolder(root='/home/user/kaixu/myGitHub/datasets/BSDS500/val/',
                                            transform=transforms.Compose([
                                                transforms.Scale(opt.image_size),
                                                transforms.CenterCrop(opt.image_size),
                                                transforms.ToTensor(),
...
def train(epochs, trainloader, valloader):
    ...
    for epoch in range(epochs):
        ...
        # training level 3
        if epoch == 0:
            lapnet3_gen.conv1.weight = copy.deepcopy(lapnet2_gen.conv1.weight)
            ...
            #lapnet3_gen.deconv7.weigth = copy.deepcopy(lapnet2_gen.deconv5.weight)
            lapnet3_gen.deconv8.weigth = copy.deepcopy(lapnet2_gen.deconv6.weight)
            lapnet3_gen.deconv9.weigth = copy.deepcopy(lapnet2_gen.deconv7.weight)
        ...
        # training level 4
        if epoch == 0:
            lapnet4_gen.conv1.weight = copy.deepcopy(lapnet3_gen.conv1.weight)
            ...
            #lapnet4_gen.deconv9.weigth = copy.deepcopy(lapnet3_gen.deconv7.weight)
            lapnet4_gen.deconv11.weigth = copy.deepcopy(lapnet3_gen.deconv9.weight)
            lapnet4_gen.deconv10.weigth = copy.deepcopy(lapnet3_gen.deconv8.weight)
            lapnet4_gen.deconv9.weigth = copy.deepcopy(lapnet3_gen.deconv7.weight)
        ...
        for idx, (data, _) in enumerate(trainloader, 0):
            ...
            d5_output = lapnet4_disc(g4_output.detach())
