...
class LAPGAN_Generator_level1(nn.Module):
    def __init__(self, channels, ngpu):
        ...
        self.linear1 = nn.Linear(self.channels * self.fs ** 2, self.channels * self.fs **2) # 3x8x8
    ...
    def forward(self, input):
        ...
        self.output = self.relu(self.bn1(self.conv1(self.output)))
        self.output = self.relu(self.resblk1(self.output))
...
# The implementation of disc1, input is 3x8x8
...
# The implementation of the disc2, input is 3x16x16
...
# The implementation of the gen3, input is 3x16x16
class LAPGAN_Generator_level3(nn.Module):
    def __init__(self, channels, ngpu, leny):
        ...
        self.conv3 = nn.Conv2d(self.base, self.base, kernel_size=3, padding=1, stride=2, bias=False)  # 64x4x4
