...
class LAPGAN(nn.Module):
    ...
    def forward(self, input, y):
        ...
        self.output = self.LAPGAN_Generator_level2(self.output, y)
        self.output = self.LAPGAN_Generator_level3(self.output, y)
        self.output = self.LAPGAN_Generator_level4(self.output, y)
