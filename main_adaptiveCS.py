...
parser.add_argument('--dataset', help='lsun | imagenet | mnist | bsd500 | bsd500_patch', default='bsd500')
...
parser.add_argument('--stage', type=int, default=3, help='the stage under training')
